...
<?php wp_nav_menu(array('theme_location' => 'booking-menu', 'container' => false, 'menu_class' => 'list-bare list-inline')); ?>
                        </nav>
                    </div>
                </div>
            </div>
...
<?php wp_nav_menu(array('theme_location' => 'booking-menu', 'container' => false, 'menu_class' => 'list-bare')); ?>
                </nav>
            </aside>
        </header>